...
const hefEllipsisHorizontalCircle = {
...
export default hefEllipsisHorizontalCircle;
export { hefEllipsisHorizontalCircle };
export { hefEllipsisHorizontalCircle as heroiconsfillEllipsisHorizontalCircle };
