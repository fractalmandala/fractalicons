...
const hefArrowRightOnRectangle = {
...
export default hefArrowRightOnRectangle;
export { hefArrowRightOnRectangle };
export { hefArrowRightOnRectangle as heroiconsfillArrowRightOnRectangle };
