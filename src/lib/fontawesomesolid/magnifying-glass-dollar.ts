...
const fasMagnifyingGlassDollar = {
...
export default fasMagnifyingGlassDollar;
export { fasMagnifyingGlassDollar };
export { fasMagnifyingGlassDollar as fontawesomesolidMagnifyingGlassDollar };
