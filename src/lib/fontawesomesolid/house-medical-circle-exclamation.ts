...
const fasHouseMedicalCircleExclamation = {
...
export default fasHouseMedicalCircleExclamation;
export { fasHouseMedicalCircleExclamation };
export { fasHouseMedicalCircleExclamation as fontawesomesolidHouseMedicalCircleExclamation };
