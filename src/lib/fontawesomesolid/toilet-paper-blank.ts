...
const fasToiletPaperBlank = {
	"name": "toilet-paper-blank",
	"set": "fontawesomesolid",
	"viewBox": "0 0 640 640",
	"body": "<path fill=\"currentColor\" d=\"M391.1 96C382.3 107.1 375.1 119.1 369.2 130.8C347.8 173.5 336 229.2 336 288L336 552C336 582.9 310.9 608 280 608L120 608C89.1 608 64 582.9 64 552L64 288C64 182 107 96 160 96L391.1 96zM480 480C427 480 384 394 384 288C384 182 427 96 480 96C533 96 576 182 576 288C576 394 533 480 480 480zM480 352C497.7 352 512 323.3 512 288C512 252.7 497.7 224 480 224C462.3 224 448 252.7 448 288C448 323.3 462.3 352 480 352z\"/>"
} as const satisfies IconData;

export default fasToiletPaperBlank;
export { fasToiletPaperBlank };
export { fasToiletPaperBlank as fontawesomesolidToiletPaperBlank };
