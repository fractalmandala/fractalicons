...
export default fasMagnifyingGlassChart;
export { fasMagnifyingGlassChart };
export { fasMagnifyingGlassChart as fontawesomesolidMagnifyingGlassChart };
