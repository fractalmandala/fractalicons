...
const fasHouseMedicalCircleCheck = {
...
export default fasHouseMedicalCircleCheck;
export { fasHouseMedicalCircleCheck };
export { fasHouseMedicalCircleCheck as fontawesomesolidHouseMedicalCircleCheck };
