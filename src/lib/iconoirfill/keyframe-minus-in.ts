...
const icfKeyframeMinusIn = {
	"name": "keyframe-minus-in",
	"set": "iconoirfill",
	"viewBox": "0 0 24 24",
	"body": "<g fill=\"none\" stroke-width=\"1.5\"><path fill-rule=\"evenodd\" clip-rule=\"evenodd\" d=\"M14.0348 2.12379C12.9437 0.923583 11.0562 0.923581 9.96509 2.12378L2.66803 10.1506C1.71449 11.1995 1.7145 12.8014 2.66805 13.8502L9.96509 21.877C11.0562 23.0772 12.9438 23.0772 14.0348 21.877L21.3319 13.8502C22.2855 12.8014 22.2855 11.1995 21.3319 10.1506L14.0348 2.12379ZM8.99999 11.25C8.58578 11.25 8.24999 11.5858 8.24999 12C8.24999 12.4142 8.58578 12.75 8.99999 12.75H12H15C15.4142 12.75 15.75 12.4142 15.75 12C15.75 11.5858 15.4142 11.25 15 11.25H12H8.99999Z\" fill=\"currentColor\"/></g>"
} as const satisfies IconData;

export default icfKeyframeMinusIn;
export { icfKeyframeMinusIn };
export { icfKeyframeMinusIn as iconoirfillKeyframeMinusIn };
