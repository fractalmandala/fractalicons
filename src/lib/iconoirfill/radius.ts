...
const icfRadius = {
	...
	"set": "iconoirfill",
	"viewBox": "0 0 24 24",
	"body": "<g fill=\"none\" stroke-width=\"1.5\"><path fill-rule=\"evenodd\" clip-rule=\"evenodd\" d=\"M22.75 12C22.75 6.06294 17.9371 1.25 12 1.25C6.06294 1.25 1.25 6.06294 1.25 12C1.25 17.9371 6.06294 22.75 12 22.75C17.9371 22.75 22.75 17.9371 22.75 12ZM15.4697 15.5303C15.7626 15.8232 16.2374 15.8232 16.5303 15.5303L19.5303 12.5303C19.8232 12.2374 19.8232 11.7626 19.5303 11.4697L16.5303 8.46967C16.2374 8.17678 15.7626 8.17678 15.4697 8.46967C15.1768 8.76256 15.1768 9.23744 15.4697 9.53033L17.1893 11.25H13.5816C13.3007 10.6588 12.6981 10.25 12 10.25C11.0335 10.25 10.25 11.0335 10.25 12C10.25 12.9665 11.0335 13.75 12 13.75C12.6981 13.75 13.3007 13.3412 13.5816 12.75H17.1893L15.4697 14.4697C15.1768 14.7626 15.1768 15.2374 15.4697 15.5303Z\" fill=\"currentColor\"/></g>"
} as const satisfies IconData;

export default icfRadius;
export { icfRadius };
export { icfRadius as iconoirfillRadius };
