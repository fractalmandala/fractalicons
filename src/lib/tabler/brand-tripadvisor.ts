...
const tbBrandTripadvisor = {
	"name": "brand-tripadvisor",
	"set": "tabler",
	"viewBox": "0 0 24 24",
	"body": "<g fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M5 13.5a1.5 1.5 0 1 0 3 0a1.5 1.5 0 1 0 -3 0\" />\n  <path d=\"M16 13.5a1.5 1.5 0 1 0 3 0a1.5 1.5 0 1 0 -3 0\" />\n  <path d=\"M17.5 9a4.5 4.5 0 1 0 3.5 1.671l1 -1.671h-4.5\" />\n  <path d=\"M6.5 9a4.5 4.5 0 1 1 -3.5 1.671l-1 -1.671h4.5\" />\n  <path d=\"M10.5 15.5l1.5 2l1.5 -2\" />\n  <path d=\"M9 6.75c2 -.667 4 -.667 6 0\" /></g>"
} as const satisfies IconData;

export default tbBrandTripadvisor;
export { tbBrandTripadvisor };
export { tbBrandTripadvisor as tablerBrandTripadvisor };
