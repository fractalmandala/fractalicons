...
const tbWhirl = {
	...
	"set": "tabler",
	"viewBox": "0 0 24 24",
	"body": "<g fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M14 12a2 2 0 1 0 -4 0a2 2 0 0 0 4 0\" />\n  <path d=\"M12 21c-3.314 0 -6 -2.462 -6 -5.5s2.686 -5.5 6 -5.5\" />\n  <path d=\"M21 12c0 3.314 -2.462 6 -5.5 6s-5.5 -2.686 -5.5 -6\" />\n  <path d=\"M12 14c3.314 0 6 -2.462 6 -5.5s-2.686 -5.5 -6 -5.5\" />\n  <path d=\"M14 12c0 -3.314 -2.462 -6 -5.5 -6s-5.5 2.686 -5.5 6\" /></g>"
} as const satisfies IconData;

export default tbWhirl;
export { tbWhirl };
export { tbWhirl as tablerWhirl };
