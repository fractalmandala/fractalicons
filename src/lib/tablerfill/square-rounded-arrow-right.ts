...
const tbfSquareRoundedArrowRight = {
...
export default tbfSquareRoundedArrowRight;
export { tbfSquareRoundedArrowRight };
export { tbfSquareRoundedArrowRight as tablerfillSquareRoundedArrowRight };
