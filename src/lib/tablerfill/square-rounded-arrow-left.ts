...
const tbfSquareRoundedArrowLeft = {
...
export default tbfSquareRoundedArrowLeft;
export { tbfSquareRoundedArrowLeft };
export { tbfSquareRoundedArrowLeft as tablerfillSquareRoundedArrowLeft };
