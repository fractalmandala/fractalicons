...
const tbfSquareRoundedArrowDown = {
...
export default tbfSquareRoundedArrowDown;
export { tbfSquareRoundedArrowDown };
export { tbfSquareRoundedArrowDown as tablerfillSquareRoundedArrowDown };
