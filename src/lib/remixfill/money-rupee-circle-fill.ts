...
const refMoneyRupeeCircleFill = {
	"name": "money-rupee-circle-fill",
	"set": "remixfill",
	"viewBox": "0 0 24 24",
...
export default refMoneyRupeeCircleFill;
export { refMoneyRupeeCircleFill };
export { refMoneyRupeeCircleFill as remixfillMoneyRupeeCircleFill };
