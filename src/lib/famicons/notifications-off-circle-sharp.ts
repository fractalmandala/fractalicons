...
const faNotificationsOffCircleSharp = {
...
export default faNotificationsOffCircleSharp;
export { faNotificationsOffCircleSharp };
export { faNotificationsOffCircleSharp as famiconsNotificationsOffCircleSharp };
