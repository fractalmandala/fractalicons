...
const faNotificationsCircleOutline = {
...
export default faNotificationsCircleOutline;
export { faNotificationsCircleOutline };
export { faNotificationsCircleOutline as famiconsNotificationsCircleOutline };
