...
const faAmericanFootballOutline = {
...
export default faAmericanFootballOutline;
export { faAmericanFootballOutline };
export { faAmericanFootballOutline as famiconsAmericanFootballOutline };
