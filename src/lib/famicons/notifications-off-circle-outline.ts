...
const faNotificationsOffCircleOutline = {
...
export default faNotificationsOffCircleOutline;
export { faNotificationsOffCircleOutline };
export { faNotificationsOffCircleOutline as famiconsNotificationsOffCircleOutline };
