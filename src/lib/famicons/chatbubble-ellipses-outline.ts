...
const faChatbubbleEllipsesOutline = {
...
export default faChatbubbleEllipsesOutline;
export { faChatbubbleEllipsesOutline };
export { faChatbubbleEllipsesOutline as famiconsChatbubbleEllipsesOutline };
