...
const faExtensionPuzzleOutline = {
...
export default faExtensionPuzzleOutline;
export { faExtensionPuzzleOutline };
export { faExtensionPuzzleOutline as famiconsExtensionPuzzleOutline };
