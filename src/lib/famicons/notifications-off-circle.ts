...
const faNotificationsOffCircle = {
...
export default faNotificationsOffCircle;
export { faNotificationsOffCircle };
export { faNotificationsOffCircle as famiconsNotificationsOffCircle };
