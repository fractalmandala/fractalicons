...
const faHeartDislikeCircleSharp = {
...
export default faHeartDislikeCircleSharp;
export { faHeartDislikeCircleSharp };
export { faHeartDislikeCircleSharp as famiconsHeartDislikeCircleSharp };
