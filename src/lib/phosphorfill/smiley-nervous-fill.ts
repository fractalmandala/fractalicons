...
const phfSmileyNervousFill = {
	"name": "smiley-nervous-fill",
	"set": "phosphorfill",
	"viewBox": "0 0 256 256",
...
export default phfSmileyNervousFill;
export { phfSmileyNervousFill };
export { phfSmileyNervousFill as phosphorfillSmileyNervousFill };
