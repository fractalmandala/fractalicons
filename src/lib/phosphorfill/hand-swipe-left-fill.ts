...
const phfHandSwipeLeftFill = {
	"name": "hand-swipe-left-fill",
	"set": "phosphorfill",
	"viewBox": "0 0 256 256",
...
export default phfHandSwipeLeftFill;
export { phfHandSwipeLeftFill };
export { phfHandSwipeLeftFill as phosphorfillHandSwipeLeftFill };
