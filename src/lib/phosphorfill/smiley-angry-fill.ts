...
const phfSmileyAngryFill = {
	"name": "smiley-angry-fill",
	"set": "phosphorfill",
	"viewBox": "0 0 256 256",
...
export default phfSmileyAngryFill;
export { phfSmileyAngryFill };
export { phfSmileyAngryFill as phosphorfillSmileyAngryFill };
