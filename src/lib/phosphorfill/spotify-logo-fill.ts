...
const phfSpotifyLogoFill = {
	"name": "spotify-logo-fill",
	"set": "phosphorfill",
	"viewBox": "0 0 256 256",
...
export default phfSpotifyLogoFill;
export { phfSpotifyLogoFill };
export { phfSpotifyLogoFill as phosphorfillSpotifyLogoFill };
