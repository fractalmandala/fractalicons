...
const phfScanSmileyFill = {
	"name": "scan-smiley-fill",
	"set": "phosphorfill",
	"viewBox": "0 0 256 256",
...
export default phfScanSmileyFill;
export { phfScanSmileyFill };
export { phfScanSmileyFill as phosphorfillScanSmileyFill };
