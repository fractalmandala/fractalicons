...
const phfSoccerBallFill = {
	"name": "soccer-ball-fill",
	"set": "phosphorfill",
	"viewBox": "0 0 256 256",
...
export default phfSoccerBallFill;
export { phfSoccerBallFill };
export { phfSoccerBallFill as phosphorfillSoccerBallFill };
