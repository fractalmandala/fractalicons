...
const phfPencilSimpleSlashFill = {
...
export default phfPencilSimpleSlashFill;
export { phfPencilSimpleSlashFill };
export { phfPencilSimpleSlashFill as phosphorfillPencilSimpleSlashFill };
