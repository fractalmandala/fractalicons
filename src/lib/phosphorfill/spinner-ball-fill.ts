...
const phfSpinnerBallFill = {
	"name": "spinner-ball-fill",
	"set": "phosphorfill",
	"viewBox": "0 0 256 256",
...
export default phfSpinnerBallFill;
export { phfSpinnerBallFill };
export { phfSpinnerBallFill as phosphorfillSpinnerBallFill };
