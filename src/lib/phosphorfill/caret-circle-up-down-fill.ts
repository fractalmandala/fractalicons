...
const phfCaretCircleUpDownFill = {
...
export default phfCaretCircleUpDownFill;
export { phfCaretCircleUpDownFill };
export { phfCaretCircleUpDownFill as phosphorfillCaretCircleUpDownFill };
