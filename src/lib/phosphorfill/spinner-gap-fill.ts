...
const phfSpinnerGapFill = {
	"name": "spinner-gap-fill",
	"set": "phosphorfill",
	"viewBox": "0 0 256 256",
...
export default phfSpinnerGapFill;
export { phfSpinnerGapFill };
export { phfSpinnerGapFill as phosphorfillSpinnerGapFill };
