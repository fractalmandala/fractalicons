...
const phfGlobeHemisphereEastFill = {
	"name": "globe-hemisphere-east-fill",
	"set": "phosphorfill",
	"viewBox": "0 0 256 256",
...
export default phfGlobeHemisphereEastFill;
export { phfGlobeHemisphereEastFill };
export { phfGlobeHemisphereEastFill as phosphorfillGlobeHemisphereEastFill };
