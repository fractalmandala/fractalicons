...
const phfCurrencyDollarSimpleFill = {
...
export default phfCurrencyDollarSimpleFill;
export { phfCurrencyDollarSimpleFill };
export { phfCurrencyDollarSimpleFill as phosphorfillCurrencyDollarSimpleFill };
