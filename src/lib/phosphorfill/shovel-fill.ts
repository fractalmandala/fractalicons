...
const phfShovelFill = {
	...
	"set": "phosphorfill",
	"viewBox": "0 0 256 256",
	"body": "<path d=\"M245.66,69.66a8,8,0,0,1-11.32,0L216,51.31l-71,71L133.66,111l71-71L186.34,21.66a8,8,0,0,1,11.32-11.32l48,48A8,8,0,0,1,245.66,69.66ZM88,176a8,8,0,0,1-5.66-13.66L133.66,111,99.31,76.68a16,16,0,0,0-22.62,0l-56,56A15.89,15.89,0,0,0,16,144v80a16,16,0,0,0,16,16h80a15.86,15.86,0,0,0,11.31-4.69l56-56a16,16,0,0,0,0-22.62L145,122.34,93.66,173.66A8,8,0,0,1,88,176Z\"/>"
} as const satisfies IconData;

export default phfShovelFill;
export { phfShovelFill };
export { phfShovelFill as phosphorfillShovelFill };
