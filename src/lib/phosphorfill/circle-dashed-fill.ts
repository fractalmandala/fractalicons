...
const phfCircleDashedFill = {
	"name": "circle-dashed-fill",
	"set": "phosphorfill",
	"viewBox": "0 0 256 256",
...
export default phfCircleDashedFill;
export { phfCircleDashedFill };
export { phfCircleDashedFill as phosphorfillCircleDashedFill };
